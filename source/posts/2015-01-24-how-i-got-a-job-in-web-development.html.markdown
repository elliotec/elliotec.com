...
A bit to my surprise, I got in, and bought a one way ticket to Seattle arriving the day before the start of my cohort on January 6th. Finding a place to stay wasn't terribly difficult (but also extraordinarily expensive compared to what I was used to in Utah) and I signed a 3 month lease in a tiny 10 x 10 apartment about a 20 minute walk from their facility.
...
So I chose a team (who has since gone on to be a [real company](http://getfastbar.com)), and had an absolutely great time. I met some really smart, interesting people. I wrote the back end of the app in Rails that connected to an iOS app. I learned so much from the iOS developer and remain friends with him, I credit him with leading me to much interest and knowledge I have now.
...
1. Exposed myself to seemingly complicated tech tasks for the purpose of exploration. This included hacking my Wii, setting up a Minecraft server, and getting familiar with various flavors of Linux.

2. Gained a real interest in the idea of web development and programming in general. Money was of course a motivator, but certainly not enough to create the passion I eventually found in the actual craft. It probably helps to be at least "tech savvy".
...
6. Started a freelancing business. This really helped me legitimize myself, if only *for* myself, and made me feel official and that I was all-in on my decision to make this my career. I made business cards, a portfolio site, a bank account, and registered my business name. Then I actually got clients and was paid to do what I had decided I wanted to get paid to do.

7. Created a web presence. Made sure I had accounts on Twitter, Linkedin, Github, Hacker News, Designer News, and a portfolio site, and beefed them all up. This was vastly beneficial, one of the most important things I did next to actually making websites and roughly equal to networking.
